...
const sections = [
  ...
  },
  {
    ...
    description:
      "Rain table and history. Requires persisted rainfall data or a safe rainfall RPC.",
    icon: CloudRain,
    status: "Blocked",
  },
  {
    ...
    title: "iOS Documents",
    description:
      "PDF / CSV / Excel exports generated by the iOS app. Needs a document index or storage bucket.",
    icon: FolderOpen,
    status: "Blocked",
  },
];
