...
const GUIDE_VISUALS: Record<string, GuideVisual> = {
  ...
  "area.setup": { Icon: Grape, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.pins": { Icon: MapPin, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.trips": { Icon: Route, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.sprays": { Icon: Droplet, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.work_tasks": { Icon: ClipboardList, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.tools": { Icon: Wrench, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.reports": { Icon: FileBarChart, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
  "area.platforms": { Icon: Smartphone, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },

  "hero.platforms": { Icon: Grape, tone: "from-muted/70 via-muted/40 to-muted/20 text-muted-foreground" },
