...
import { elColour, type BlockHeat, type RGB } from "@/lib/growthHeatmap";

export function blockHeatDataUrl(
  block: BlockHeat,
  maxAlpha = 0.72,
  /** Colour ramp for the current development phase. */
  colourFor: (el: number) => RGB = elColour,
): string | null {
